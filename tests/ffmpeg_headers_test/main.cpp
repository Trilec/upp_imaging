...
static String FindRepositoryRoot()
{
	...
	for(int i = 0; i < 8 && !dir.IsEmpty(); i++) {
		if(FileExists(AppendFileName(dir, "third_party/ffmpeg/ffmpeg_headers/generated/config.h")) &&
		   FileExists(AppendFileName(dir, "third_party/ffmpeg/ffmpeg_avutil_src/import.ext")))
			return AppendFileName(dir, "third_party/ffmpeg");
