...
static int RunTests()
{
	...
	std::filesystem::path file_config_path = std::filesystem::path("third_party/opencolorio/opencolorio_src/upstream/src/OpenColorIO/builtinconfigs/configs") / "studio-config-v4.0.0_aces-v2.0_ocio-v2.5.ocio";
