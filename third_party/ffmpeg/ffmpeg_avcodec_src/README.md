...
Generated registry files in `third_party/ffmpeg/ffmpeg_headers/generated/libavcodec` expose exactly one codec (`ff_h264_decoder`) and empty parser/BSF lists. Internal H.264/MPEG-4 parsing helpers are implementation details and do not silently enable additional public codec/parser components.
