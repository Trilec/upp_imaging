...
- openexr_src: pass (`openexr_src_test` reports the strict source boundary and the deterministic RGBA round-trip)
- openexr_core_src: pass (`openexr_core_write_probe`/`openexr_core_roundtrip_test` report version 3.4.13, public headers, and compression coverage)
