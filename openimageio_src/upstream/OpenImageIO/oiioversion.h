...
#define OIIO_VERSION OIIO_MAKE_VERSION(OIIO_VERSION_MAJOR, OIIO_VERSION_MINOR, OIIO_VERSION_PATCH)
...
#define OIIO_VERSION_STRING OIIO_MAKE_VERSION_STRING(OIIO_VERSION_MAJOR, OIIO_VERSION_MINOR, OIIO_VERSION_PATCH, OIIO_VERSION_TWEAK, OIIO_VERSION_RELEASE_TYPE)
#define OIIO_INTRO_STRING "OpenImageIO " OIIO_VERSION_STRING " http://www.openimageio.org"
#define OIIO_VERSION_STRING_MMPT OIIO_MAKE_VERSION_STRING(OIIO_VERSION_MAJOR, OIIO_VERSION_MINOR, OIIO_VERSION_PATCH, OIIO_VERSION_TWEAK, "")
...
namespace OpenImageIO { inline namespace v3_1 { } namespace v3_0 { } }
