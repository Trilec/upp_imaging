...
- generated config header: `third_party/imath/imath_src/upstream/ImathConfig.h` was created from upstream `config/ImathConfig.h.in` using upstream release defaults
- license text: `third_party/imath/imath_src/upstream/LICENSE.md`
