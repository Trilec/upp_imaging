...
// Repository adaptation: preserve hidden RGB under transparent pixels for
// lossless output by enabling WebPConfig::exact.
...
WebpOutput::open(const std::string& name, const ImageSpec& spec, OpenMode mode)
{
    ...
    m_webp_config.exact    = int(is_lossless);
