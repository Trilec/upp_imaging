...
#include <minizip_ng_src/mz.h>
#include <minizip_ng_src/mz_strm.h>
#include <minizip_ng_src/mz_zip.h>
...
int main()
{
	...
	const String zip_path = GetExeDirFile("minizip_ng_roundtrip.zip");
	...
	const String bad_path = GetExeDirFile("minizip_ng_bad.zip");
	{
